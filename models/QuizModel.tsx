...
export class Convert {
    public static toSortBy(json: string): SortBy[] {
        return cast(JSON.parse(json), a(r("SortBy")));
    }

    public static sortByToJson(value: SortBy[]): string {
        return JSON.stringify(uncast(value, a(r("SortBy"))), null, 2);
    }
}
...
const typeMap: any = {
    "SortBy": o([
        ...
        { json: "correct_answer", js: "correctAnswer", typ: "" },
        { json: "incorrect_answers", js: "incorrectAnswers", typ: a("") },
    ], false),
    "Difficulty": [
        "easy",
        "hard",
